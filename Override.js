  ...
  config["proxy-groups"] = [
    {
      ...
      "name": "⚙️ 节点选择",
      "type": "select",
      "proxies": ["♻️ 延迟选优", "🚑 故障转移", "香港节点", "美国节点", "狮城节点", "日本节点", "台湾节点"],
      "include-all": true,
    ...
    },
    {
      ...
      "name": "🌍 国外媒体",
      "type": "select",
      "proxies": ["⚙️ 节点选择", "♻️ 延迟选优", "🚑 故障转移", "香港节点", "美国节点", "狮城节点", "日本节点", "台湾节点", "🔗 全局直连"],
      "include-all": true,
    ...
    },
    {
      ...
      "name": "💵 Claude",
      "type": "select",
      "proxies": ["⚙️ 节点选择", "🔗 全局直连", "♻️ 延迟选优", "🚑 故障转移", "香港节点", "美国节点", "狮城节点", "日本节点", "台湾节点"],
      "include-all": true,
